...
(cl:defmethod cl:initialize-instance :after ((m <poi>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'poi)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name go_to_poi-msg:<poi> is deprecated: use go_to_poi-msg:poi instead.")))

(cl:ensure-generic-function 'poi-val :lambda-list '(m))
(cl:defmethod poi-val ((m <poi>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader go_to_poi-msg:poi-val is deprecated.  Use go_to_poi-msg:poi instead.")
  (poi m))
